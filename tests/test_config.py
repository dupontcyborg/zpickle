...
import zpickle
from zpickle.config import ZpickleConfig, DEFAULT_ALGORITHM, DEFAULT_LEVEL, MIN_SIZE_FOR_COMPRESSION
...
def test_min_size_threshold():
    ...
    assert large_result[5] == zpickle.format.ALGORITHM_IDS[DEFAULT_ALGORITHM]  # Compressed
